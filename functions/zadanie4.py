...
def test_formatuj_napis_bez_znaczników_ale_ze_zmienna_jako_argument():
    assert formatuj("Hello World", name="John") == "Hello World"

def test_formatuj_napis_bez_znaczników_ale_ze_zmiennymi_jako_argumenty():
    assert formatuj("Hello World", name="John", lastname="Kovalsky") == "Hello World"

def test_formatuj_napis_ze_zmienna_():
